...
2. In the **Artifacts** panel, select **HTTP Service** under **Integration as API**.
   ...
   ![Artifacts panel showing HTTP Service under Integration as API](/img/develop/integration-artifacts/service/http/step-2.png)

3. In the creation form, fill in the following fields:

   ![HTTP Service creation form](/img/develop/integration-artifacts/service/http/step-creation-form.png)
...
5. WSO2 Integrator opens the service in the **Service Designer**. The header shows the attached listener pill, the base path, and the list of resource functions.
   ...
   ![Service Designer showing the HTTP service canvas](/img/develop/integration-artifacts/service/http/step-3.png)
...
7. Click the resource row to open it in the **flow designer**.
   ...
   ![Flow designer showing the resource canvas](/img/develop/integration-artifacts/service/http/step-4.png)
