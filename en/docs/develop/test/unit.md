...
5. Expand **Advanced Configurations** to set additional options:
   ...
   | **Data Provider** | Function that supplies multiple data sets to the test function. See [Data-Driven Tests](data-driven.md). |
...
For more options — parallel execution, code coverage, and report formats — see [Execute Tests](execute.md).
...
- [Data-Driven Tests](data-driven.md) — parameterize tests with data providers to run the same logic against multiple inputs
...
- [Execute Tests](execute.md) — all options for running tests and viewing results
