...
<ThemedImage
    ...
    sources={{
        light: useBaseUrl('/img/get-started/file-integration/create-the-project-light.gif'),
        dark: useBaseUrl('/img/get-started/file-integration/create-the-project-dark.gif'),
    }}
/>
...
<ThemedImage
    ...
    sources={{
        light: useBaseUrl('/img/get-started/file-integration/add-a-file-integration-artifact-light.gif'),
        dark: useBaseUrl('/img/get-started/file-integration/add-a-file-integration-artifact-dark.gif'),
    }}
/>
...
<ThemedImage
    ...
    sources={{
        light: useBaseUrl('/img/get-started/file-integration/tracking-modified-files-light.gif'),
        dark: useBaseUrl('/img/get-started/file-integration/tracking-modified-files-dark.gif'),
    }}
/>
...
<ThemedImage
    alt="Run and Test"
    sources={{
        light: useBaseUrl('/img/get-started/file-integration/run-and-test-light.gif'),
        dark: useBaseUrl('/img/get-started/file-integration/run-and-test-dark.gif'),
    }}
/>
...
- [Quick start: Automation](automation.md): Build scheduled jobs.
