...
<ThemedImage
    ...
    sources={{
        light: useBaseUrl('/img/get-started/automation/create-the-project-light.gif'),
        dark: useBaseUrl('/img/get-started/automation/create-the-project-dark.gif'),
    }}
/>
...
<ThemedImage
    ...
    sources={{
        light: useBaseUrl('/img/get-started/automation/add-an-automation-artifact-light.gif'),
        dark: useBaseUrl('/img/get-started/automation/add-an-automation-artifact-dark.gif'),
    }}
/>
...
<ThemedImage
    alt="Add logic"
    sources={{
        light: useBaseUrl('/img/get-started/automation/add-logic-light.gif'),
        dark: useBaseUrl('/img/get-started/automation/add-logic-dark.gif'),
    }}
/>
...
<ThemedImage
    alt="Run and test"
    sources={{
        light: useBaseUrl('/img/get-started/automation/run-and-test-light.gif'),
        dark: useBaseUrl('/img/get-started/automation/run-and-test-dark.gif'),
    }}
/>
...
- [Quick Start: Event Integration](event-integration.md) -- React to messages from brokers
