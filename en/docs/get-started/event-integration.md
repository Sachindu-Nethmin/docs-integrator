...
<ThemedImage
    ...
    sources={{
        light: useBaseUrl('/img/get-started/event-integration/create-a-new-integration-project-light.gif'),
        dark: useBaseUrl('/img/get-started/event-integration/create-a-new-integration-project-dark.gif'),
    }}
/>
...
<ThemedImage
    ...
    sources={{
        light: useBaseUrl('/img/get-started/event-integration/add-a-rabbitmq-event-integration-artifact-light.gif'),
        dark: useBaseUrl('/img/get-started/event-integration/add-a-rabbitmq-event-integration-artifact-dark.gif'),
    }}
/>
...
<ThemedImage
    ...
    sources={{
        light: useBaseUrl('/img/get-started/event-integration/configure-the-rabbitmq-connection-light.gif'),
        dark: useBaseUrl('/img/get-started/event-integration/configure-the-rabbitmq-connection-dark.gif'),
    }}
/>
...
<ThemedImage
    ...
    sources={{
        light: useBaseUrl('/img/get-started/event-integration/add-message-processing-logic-light.gif'),
        dark: useBaseUrl('/img/get-started/event-integration/add-message-processing-logic-dark.gif'),
    }}
/>
...
<ThemedImage
    ...
    sources={{
        light: useBaseUrl('/img/get-started/event-integration/run-and-test-the-integration-light.gif'),
        dark: useBaseUrl('/img/get-started/event-integration/run-and-test-the-integration-dark.gif'),
    }}
/>
...
- [Quick Start: File Integration](file-integration.md) -- Process files from FTP or local directories
- [Quick Start: Integration as API](api-integration.md) -- Build an HTTP service
