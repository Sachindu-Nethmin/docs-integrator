...
WSO2 Integrator is a 100% open-source, Ballerina-powered integration platform that combines low-code simplicity with pro-code power. You design integrations visually in your development environment, and the platform generates production-ready Ballerina code or you write code directly and see it reflected in the visual designer.
...
1. Design time: Development environment with visual designer, code editor, and AI assistance.
2. Runtime: Ballerina-powered execution engine with built-in networking, concurrency, and type safety.
3. Deployment: Deploy anywhere: Self-Hosted (Docker, Kubernetes, VM, bare metal) or SaaS (fully managed infrastructure).
...
- [Set Up Your Environment](install.md): Get set up
