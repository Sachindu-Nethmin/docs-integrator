...
<ThemedImage
    ...
    sources={{
        light: useBaseUrl('/img/get-started/ai-agent/create-the-project-light.gif'),
        dark: useBaseUrl('/img/get-started/ai-agent/create-the-project-dark.gif'),
    }}
/>
...
<ThemedImage
    ...
    sources={{
        light: useBaseUrl('/img/get-started/ai-agent/add-a-file-integration-artifact-light.gif'),
        dark: useBaseUrl('/img/get-started/ai-agent/add-a-file-integration-artifact-dark.gif'),
    }}
/>
...
<ThemedImage
    ...
    sources={{
        light: useBaseUrl('/img/get-started/ai-agent/configure-the-ai-agent-light.gif'),
        dark: useBaseUrl('/img/get-started/ai-agent/configure-the-ai-agent-dark.gif'),
    }}
/>
...
<ThemedImage
    alt="Run and test"
    sources={{
        light: useBaseUrl('/img/get-started/ai-agent/run-and-test-light.gif'),
        dark: useBaseUrl('/img/get-started/ai-agent/run-and-test-dark.gif'),
    }}
/>
