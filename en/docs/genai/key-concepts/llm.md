...
- [What is a Natural Function?](natural-function.md) -- The simplest way to use an LLM in code
- [What is an AI Agent?](ai-agent.md) -- LLMs combined with tools and memory
