...
Content filters work alongside [input/output guardrails](input-output.md) but focus specifically on the semantic content of messages rather than structural validation.
...
- [Input/Output Guardrails](input-output.md) -- Structural validation for AI inputs and outputs
