...
If your code is still on your machine, you're in [Develop](../develop/index.md). Once you're pushing it somewhere else, you're here.
:::
...
**Environment management:** [Environments](deploy/environments.md) | [Managing Configurations](deploy/manage-configurations.md) | [Scaling & High Availability](deploy/scaling-ha.md)
...
| | |
|---|---|
| **[Observability Overview](observe/index.md)** | Logging, metrics, and tracing concepts |
...
- **[Overview & Sizing Guidelines](capacity-planning/index.md)** — Right-size your deployment
